...
puree= read_csv("aurnapurity.csv")
puree$id=colnames(rnaseq)
puree=puree[,c(3,2)]
...
dds <- DESeqDataSetFromMatrix(countData=rnaseq, colData=auidpuree, design = ~ grp )
...
#adj.counts.au= adj.counts
#save( adj.counts.au, file="adj.counts.au.RData")
